class MySimpleSynthController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "MySimpleSynth", options);
  }
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      ...
      actx.audioWorklet.addModule(origin + "scripts/MySimpleSynth-awp.js").then(() => {
        resolve();
      }) }) }) });
    })
  }
